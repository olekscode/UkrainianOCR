...
# I did some python scripting and manual selection to get this
# list of fonts that are installed on my system and support
# Ukrainian letters. Later I will replace this ugly list with
# some nice function that will be able to do the same thing
# automatically on any other computer
fonts=(
    ...
    for font in ${fonts[@]}; do
        for degr in ${rot_degr[@]}; do
           convert -background black \
                   ...
                   -depth 8 \
                   -font $font \
               label:${letters[$COUNTER]} img/$COUNTER.$font.$degr.png;
